...
<div class="header">
	<div class="container">
			   ...
			   <div class="header-icons">
			   	 <ul>
			   	 	<li><a href="https://www.facebook.com/Blood-Bank-Information-System-1568992976507861" class="fb" target="_blank"> </a></li>
	...
	<div class="container">
		<div class="vedio-main">
			<div class="col-md-6 vedio-left wow fadeInLeft" data-wow-delay="0.3s">
				...
				<p>Blood is universally recognized as the most precious element that sustains life. It saves innumerable lives across the world in a variety of conditions. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed.
...
<div class="charity">
	<div class="container">
		<div class="charity-main wow fadeInRight" data-wow-delay="0.3s">
			<h3>"No one has ever become Poor by Donating Blood" </h3>
	...
	<div class="container">
		<div class="donate-main">
			<div class="col-md-3 donate-grid wow fadeInLeft" data-wow-delay="0.3s">
				<h3>Donate</h3>
				<h4>Our Gallery</h4>
				<p>Images of some Blood Donation camp held in different places...</p>
			</div>
			<div class="col-md-3 donate-grid wow fadeInLeft" data-wow-delay="0.3s">
				<div class="fall-down-effect top">
							<div class="img-box"><img src="images/d1.jpg" alt="" height=200px width=300px></div>
							<div class="text-box">
				...
				<h5>At Lions club, Jorhat</h5>	
				<p>A camp held on 25th april 2017...</p>
			</div>
			<div class="col-md-3 donate-grid wow fadeInRight" data-wow-delay="0.3s">
				<div class="fall-down-effect top">
							<div class="img-box"><img src="images/d2.jpg" alt="" height=200px width=300px ></div>
							<div class="text-box">
								<div class="text-content">
									<h3>Donate</h3>																																		
								</div>
				...
				<h5>At Kaziranga University, Jorhat</h5>		
				<p>A camp held on 2nd May 2017...</p>			
			</div>
			<div class="col-md-3 donate-grid wow fadeInRight" data-wow-delay="0.3s">
				<div class="fall-down-effect top">
							<div class="img-box"><img src="images/d3.jpg" alt="" height=200px width=300px></div>
							<div class="text-box">
								<div class="text-content">
									<h3>Donate</h3>																																		
								</div>
				...
				<h5>At J.B College, Jorhat</h5>		
				<p>A camp held on 10th May 2017...</p>
			</div>
		</div>
	</div>
</div>
		...
		<div class="footer-main">
			<div class="col-md-4 ftr-grid">
				...
				<ul>
					...
					<li><a href="donar.php">Info for Donor</a></li>
